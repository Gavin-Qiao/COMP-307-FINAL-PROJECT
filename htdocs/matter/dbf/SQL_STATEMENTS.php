...
class SQL_STATEMENTS
{
    ...
    */
    ...
    public const DELETE_TA_COURSE              = "DELETE FROM REGISTER_TA_COURSE         WHERE TID = ? AND CID = ?;";

    public const DELETE_INSTRUCTOR_COURSE      = "DELETE FROM REGISTER_INSTRUCTOR_COURSE WHERE IID = ? AND CID = ?;";

    public const DELETE_STUDENT_COURSE         = "DELETE FROM REGISTER_STUDENT_COURSE    WHERE SID = ? AND CID = ?;";
